...
def get_bert_feature(text, word2ph, device, model_path="bert-base-multilingual-uncased"):
    from . import chinese_bert
    return chinese_bert.get_bert_feature(text, word2ph, model_id=model_path, device=device)
